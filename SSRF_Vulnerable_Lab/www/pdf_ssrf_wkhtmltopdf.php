...
//passthru('"'.$path_pdf_converter.'" -T 0 -R 0 -B 0 -L 0 --orientation Portrait --page-size A4 sample.html output4.pdf'); /*remove the comment if you want to use it on Windows machine*/
 passthru('xvfb-run wkhtmltopdf -T 0 -R 0 -B 0 -L 0 --orientation Portrait --encoding "utf-8" --page-size A4 --quiet sample.html output4.pdf 2>&1'); //comment this line if you want to use code on Windows
